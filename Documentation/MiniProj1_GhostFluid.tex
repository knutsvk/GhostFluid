...
\pgfplotstableread{../Results/Toro1_OGFM_FORCE_N5000.out}{\exact}
\pgfplotstableread{../Results/Toro1_MGFM_MUSCL_minbee_N100.out}{\one}
\pgfplotstableread{../Results/Toro1_MGFM_MUSCL_minbee_N200.out}{\two}
\pgfplotstableread{../Results/Toro1_MGFM_MUSCL_minbee_N400.out}{\four}
\pgfplotstableread{../Results/Toro1_MGFM_MUSCL_minbee_N2000.out}{\tausen}
...
\begin{figure*}[htb]
    ...
    \begin{tikzpicture}
        ...
        \end{groupplot}
    \end{tikzpicture}
\caption{Modified Ghost Fluid method for Toro's test 1.
    \textcolor{red}{$\triangle$}$N=100$
    \textcolor{blue}{$\circ$}$N=200$
    \textcolor{purple}{$\square$}$N=400$ 
    \textcolor{teal}{$\times$}$N=1000$ }
