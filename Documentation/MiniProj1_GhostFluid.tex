...
Write about the results from test D here. 
...
Write about the results from test E here. 
...
% \forach \n in {1,..,5}
% {
%   Do the plotting here with ``Toro1'' replaced by ``Toro\n''
% }
